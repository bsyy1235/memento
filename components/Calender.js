...
export default function Calendar() {
  ...
  const [statusData, setStatusData] = useState({
    ...
    "2025-04-01": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
    "2025-04-02": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
    "2025-04-03": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
    "2025-04-04": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
    "2025-04-05": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
    "2025-04-09": { todoCompleted: true, diaryStatus: "in-progress", feeling:"none" },
    "2025-04-10": { todoCompleted: true, diaryStatus: "none", feeling:"none" },
    "2025-04-11": { todoCompleted: false, diaryStatus: "in-progress", feeling:"none" },
    "2025-04-12": { todoCompleted: true, diaryStatus: "completed", feeling:"joy" },
    "2025-04-13": { todoCompleted: false, diaryStatus: "completed", feeling:"sad" },
    "2025-04-20": { todoCompleted: true, diaryStatus: "completed", feeling:"tired" },
  ...
  const getDateStatus = (day) => {
    ...
    return statusData[dateString] || { todoCompleted: false, diaryStatus: "none" };
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity 
          ...
          onPress={() => navigateToScreen('오늘의 할 일')}
        >
          <Text style={styles.navButtonText}>오늘의 할 일 &gt;</Text>
        </TouchableOpacity>
        
        <TouchableOpacity 
          style={styles.navButton}
          onPress={() => navigateToScreen('오늘의 다이어리')}
        >
          <Text style={styles.navButtonText}>오늘의 다이어리 &gt;</Text>
        </TouchableOpacity>
        
        <TouchableOpacity 
          style={styles.navButton}
          onPress={() => navigateToScreen('다이어리 모아보기')}
        >
          <Text style={styles.navButtonText}>다이어리 모아보기 &gt;</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
